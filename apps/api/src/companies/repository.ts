...
export class CompanyRepository {
   ...
   * Returns company with domains array
   */
  async upsertWithDomains(data: NewCompany & { domains: string[] }): Promise<Company & { domains: string[] }> {
    ...
    return await this.db.transaction(async (tx) => {
      ...
      // Step 3: Fetch all domains for this company within the same transaction

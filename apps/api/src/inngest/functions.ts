  ...
  return inngest.createFunction(
    {
      ...
      retries: {
        ...
        // Retry after 1min, 3min, 5min, 10min, 30min, 1hr, 3hr, 6hr, 12hr
        attempts: 9,
        schedule: [
          ...
          { delay: '1h' },  // 6th retry: 1 hour
          { delay: '3h' },  // 7th retry: 3 hours
          { delay: '6h' },  // 8th retry: 6 hours
          { delay: '12h' }, // 9th retry: 12 hours
        ],
      },
